...
public class FoundRoomAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final LayoutInflater inflater;
    private final List<String> values;

    public FoundRoomAdapter(Context context, List<String> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View rowView = inflater.inflate(R.layout.item_room_found, parent, false);

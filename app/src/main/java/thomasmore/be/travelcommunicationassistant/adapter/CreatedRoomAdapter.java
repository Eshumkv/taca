...
public class CreatedRoomAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final LayoutInflater inflater;
    private final List<String> values;
    private final View.OnClickListener clickListener;

    public CreatedRoomAdapter(Context context, List<String> values, View.OnClickListener clickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View rowView = inflater.inflate(R.layout.item_room_created, parent, false);
